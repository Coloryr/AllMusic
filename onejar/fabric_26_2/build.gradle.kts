...
val clientSourceDir = project(":client:fabric_26_2").projectDir.resolve("src/main/java/com/coloryr/allmusic/client")
val serverSourceDir = project(":server:fabric_26_2").projectDir.resolve("src/main/java/com/coloryr/allmusic/server")
val commSourceDir = project(":server:fabric_26_2").projectDir.resolve("src/main/java/com/coloryr/allmusic/comm")
val clientResDir = project(":client:fabric_26_2").projectDir.resolve("src/main/resources")
val serverResDir = project(":server:fabric_26_2").projectDir.resolve("src/main/resources")
