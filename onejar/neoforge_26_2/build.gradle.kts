...
val clientSourceDir = project(":client:neoforge_26_2").projectDir.resolve("src/main/java/com/coloryr/allmusic/client")
val serverSourceDir = project(":server:neoforge_26_2").projectDir.resolve("src/main/java/com/coloryr/allmusic/server")
val commSourceDir = project(":server:neoforge_26_2").projectDir.resolve("src/main/java/com/coloryr/allmusic/comm")
val clientResDir = project(":client:neoforge_26_2").projectDir.resolve("src/main/resources")
...
tasks {
    ...
    shadowJar {
        archiveFileName.set("[neoforge-26.2]AllMusic-${project.version}.jar")
