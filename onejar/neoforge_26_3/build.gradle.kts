...
val clientSourceDir = project(":client:neoforge_26_3").projectDir.resolve("src/main/java/com/coloryr/allmusic/client")
val serverSourceDir = project(":server:neoforge_26_3").projectDir.resolve("src/main/java/com/coloryr/allmusic/server")
val commSourceDir = project(":server:neoforge_26_3").projectDir.resolve("src/main/java/com/coloryr/allmusic/comm")
val clientResDir = project(":client:neoforge_26_3").projectDir.resolve("src/main/resources")
...
dependencies {
    ...
    implementation(include("net.kyori:adventure-platform-neoforge:7.2.0")!!)
}
...
tasks {
    ...
    shadowJar {
        archiveFileName.set("[neoforge-26.3]AllMusic-${project.version}.jar")
